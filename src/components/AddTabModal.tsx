...
export function AddTabModal({ onClose, onAdd, existingTabs }: AddTabModalProps) {
  const [name, setName] = useState("");
  const [selectedColor, setSelectedColor] = useState<TabColor>('blue');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const isDuplicate = existingTabs.some(
      tab => tab.name.toLowerCase() === name.trim().toLowerCase()
    );
